...
config = {
    "images_dir":       "/andromeda/datasets/COCO/COCO2017_val/val2017",
    "annotations_path": "/andromeda/datasets/COCO/COCO2017_val/annotations/instances_val2017.json",  # <-- modifica
    "masks_output_dir": "/equilibrium/ldelbene/Immunization",                         # <-- modifica
    "category":         "person",
    "test_img_id":      250282,  # <-- id immagine da testare (puoi cambiarlo)
}
